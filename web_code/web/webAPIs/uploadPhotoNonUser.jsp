...
<%
   StringData loggedOnWebUser = new StringData();
   loggedOnWebUser.userId = "8";
   loggedOnWebUser.userEmail = "fake@gmail.com";
   loggedOnWebUser.userPassword = "fake";
