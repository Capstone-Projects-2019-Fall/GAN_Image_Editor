...
function displayFacialGAN(responseContainerId, picPathFromAccount) {
                ...
                <div class="inner">
                        <article style="padding: 0% 5%">
                                <div class="content ganModelImgContainer">
                                        ...
                                        <form method="post" action="webAPIs/uploadPhoto.jsp" encType="multipart/form-data" id="uploadFacialForm" style="display: none;">
                                        ...
                                        <div id="facialPicDesc" style="min-height: 15px;"></div>
                                        <button id="facialInputButton" style="box-shadow: 2px 2px 5px black; border-radius: 3px;">Upload Image</button>
                        ...
                        <article class="alt" style="padding: 0% 5%">
                                <div class="content ganModelImgContainer">
                                        ...
                                        <div class="image fit" style=" margin-bottom: 8px;">
                                                <img style="max-height: 384px; max-width:384px;" id="facialOutputImg" src="pics/test/image-placeholder.png" alt="" />
                                        </div>
    
                                        <div id="facialRunOutputPicDesc" style="min-height: 15px;"></div>
                                        <button id="facialRunButton" style="box-shadow: 2px 2px 5px black; border-radius: 3px;">Run Trained Model</button>
                                </div>
                        </article>
                        <article class="alt" style="padding: 0% 5%">
                                <div class="content ganModelImgContainer">
                                        ...
                                        <div class="image fit"  style="text-align:center; margin-bottom: 8px;">
                                                <img style="display:inline-block; max-height: 128px; max-width:128px;" id="customFacialOutputImg" src="pics/test/image-placeholder.png" alt="" />
                                        </div>
    
                                        <div id="facialCustomRunOutputPicDesc" style="min-height: 15px;"></div>
                                        <button id="customFacialRunButton" style="box-shadow: 2px 2px 5px black; border-radius: 3px;">Run Custom Model</button>
                                </div>
                        </article>
                </div>
        </section>
    ...
    document.getElementById("facialSubmitButton").addEventListener('click', function(){ajax_upload_form_non_user("uploadFacialForm", "facialInputImg", "facialPicDesc");});
    ...
    if(picPathFromAccount){
        document.getElementById("facialInputImg").setAttribute("src", picPathFromAccount);
        /*
        var path1 = picPathFromAccount.substr(picPathFromAccount.indexOf("test/"));
        path1 = path1.substr(5);
        
        placeImageDimensions(path1, "facialInputImg");
        */
    }
    ...
    function facialRun(modelInt){
        ...
        if(modelInt.includes("0")){
            runFlask({picDescId: "facialRunOutputPicDesc", paramString: paramStringToSend, portNum: '7010', funcInvoke: 'facial', imgId: 'facialInputImg', responseId:responseContainerId, modelType: modelInt});
        }
        else{
            runFlask({picDescId: "facialCustomRunOutputPicDesc", paramString: paramStringToSend, portNum: '7010', funcInvoke: 'facial', imgId: 'facialInputImg', responseId:responseContainerId, modelType: modelInt});
        }
