...
public final class getUserImageFileNames_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    StringDataListImage list = new StringDataListImage();
    ...
    if (list.dbError.length() == 0) { // if got good DB connection,
        ...
        System.out.println(loggedOnWebUser.userEmail);
        list = WebUserView.getUserImages(dbc, loggedOnWebUser);
    }
