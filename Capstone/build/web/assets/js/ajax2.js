...
function ajax2 (params){
    ...
    if (!params || !params.url || !params.successFn || !params.fileId || !params.errorId) {
        alert ("Function ajax2 requires an input parameter object with properties: url, successFn, fileId, and errorId");
        return;
    }
    ...
    httpReq.open("POST", params.url); // specify which page you want to get
